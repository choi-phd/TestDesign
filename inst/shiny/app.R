...
server = function(input, output, session) {
  ...
  observeEvent(input$problemtype, {
    if (input$problemtype == 2){
      ...
      shinyjs::hide("maxinfo.button")
      shinyjs::show("exposure.dropdown")
      shinyjs::show("theta.settings")
      shinyjs::show("itemselection.method")
      shinyjs::show("contentbalancing.method")
      shinyjs::show("refreshpolicy.dropdown")
      shinyjs::show("simulation.dropdown")
      ...
      shinyjs::show("maxinfo.button")
      shinyjs::hide("exposure.dropdown")
      shinyjs::hide("theta.settings")
      shinyjs::hide("itemselection.method")
      shinyjs::hide("contentbalancing.method")
      shinyjs::hide("refreshpolicy.dropdown")
      shinyjs::hide("simulation.dropdown")
