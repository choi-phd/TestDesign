...
parseDiagnosticStats <- function(
  ...
  for (j in 1:constants$nj) {
    ...
    o$elg_stats[[j]]$a_g_i <- exposure_record_detailed$a_g_i
    o$elg_stats[[j]]$e_g_i <- exposure_record_detailed$e_g_i

    if (constants$set_based) {
      o$elg_stats[[j]]$a_g_s <- exposure_record_detailed$a_g_s
      o$elg_stats[[j]]$e_g_s <- exposure_record_detailed$e_g_s
    }
  ...
  for (j in 1:constants$nj) {
    ...
    o$elg_stats_nofade[[j]]$a_g_i_nofade <- exposure_record_detailed$a_g_i_nofade
    o$elg_stats_nofade[[j]]$e_g_i_nofade <- exposure_record_detailed$e_g_i_nofade

    if (constants$set_based) {
      o$elg_stats_nofade[[j]]$a_g_s_nofade <- exposure_record_detailed$a_g_s_nofade
      o$elg_stats_nofade[[j]]$e_g_s_nofade <- exposure_record_detailed$e_g_s_nofade
    }
