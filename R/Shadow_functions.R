...
#' +.item.pool
#' 
#' Combine two objects of class \code{\linkS4class{item.pool}}
#' 
...
#' -.item.pool
#' 
#' Subtract the second from the first if the two item.pool objects overlap
#' 
#' @param pool1 An \code{\linkS4class{item.pool}} object
#' @param pool2 An \code{\linkS4class{item.pool}} object
#' 
...
#' ==.item.pool
#' 
#' Test the equality of two item.pool objects
#' 
#' @param pool1 An \code{\linkS4class{item.pool}} object
#' @param pool2 An \code{\linkS4class{item.pool}} object
#' 
...
#' MakeTest
#' 
#' Generate an \code{\linkS4class{test}} object
#' 
#' @docType methods
#' @rdname MakeTest-methods
#' @export
...
#' MakeTestCluster
#' 
#' Generate an \code{\linkS4class{test.cluster}} object
#' 
#' @docType methods
#' @rdname MakeTestCluster-methods
...
#' EAP
#' 
#' Genereate expected a posteriori estimates of theta
#' 
#' @docType methods
#' @rdname eaparray-methods
setMethod(f = "EAP",
...
#' Shadow
#' 
#' Run generalized shadow-test approach to CAT
#' 
#' @rdname Shadow-methods
#' @export
setMethod(f = "Shadow",
...
#' 
#' @param config A \code{\linkS4class{Shadow.config}} object                                          
#' @param object An object containing eligibility statistics generated by \code{\linkS4class{Shadow}}
#' @param objectNoFading An object containing eligibility statistics generated without fading
#' @param file A file name of an object containing eligibility statistics generated by \code{\linkS4class{Shadow}}
...
#' 
#' @param RMSE.foc A vector of RMSE values for a focal group
#' @param RMSE.ref A vector of RMSE values for a reference group
...
#' @param config An object of class \code{\link{Shadow.config}}
#' @param maxRate A target item exposure rate
#' @param PDF If supplied a filename, save as a PDF file
...
#' @param pool An object of class \code{\linkS4class{item.pool}} 
#' @param theta A theta grid
