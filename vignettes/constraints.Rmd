...
This document explains how to create constraints. In test assembly, practitioners often want to select the items that satify various types of constraints. As of *TestDesign* version 1.0, constraints can be read in from a `.csv` spreadsheet file or a data.frame object. Constraints are expected to be in the following structure:
