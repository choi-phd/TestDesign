...
item_params_A    = read.csv("data-raw/item_params_A.csv", header = T)
item_params_B    = read.csv("data-raw/item_params_B.csv", header = T)
item_params_C    = read.csv("data-raw/item_params_C.csv", header = T)
