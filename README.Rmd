...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/choi-phd/TestDesign.svg?branch=master)](https://travis-ci.com/choi-phd/TestDesign)
...
Install the development version (1.1.0) from [GitHub](https://github.com/):
