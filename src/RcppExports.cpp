...
RcppExport SEXP _Shadow_array_p_m_gr(SEXP xSEXP, SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type x(xSEXP);
    Rcpp::traits::input_parameter< arma::rowvec >::type a(aSEXP);
    Rcpp::traits::input_parameter< arma::rowvec >::type b(bSEXP);
    rcpp_result_gen = Rcpp::wrap(array_p_m_gr(x, a, b));
    return rcpp_result_gen;
END_RCPP
}
// info_1pl
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Shadow_array_p_m_3pl", (DL_FUNC) &_Shadow_array_p_m_3pl, 4},
    {"_Shadow_p_pc", (DL_FUNC) &_Shadow_p_pc, 2},
    {"_Shadow_p_m_pc", (DL_FUNC) &_Shadow_p_m_pc, 2},
    {"_Shadow_array_p_pc", (DL_FUNC) &_Shadow_array_p_pc, 2},
    {"_Shadow_array_p_m_pc", (DL_FUNC) &_Shadow_array_p_m_pc, 2},
    {"_Shadow_p_gpc", (DL_FUNC) &_Shadow_p_gpc, 3},
    {"_Shadow_p_m_gpc", (DL_FUNC) &_Shadow_p_m_gpc, 3},
    {"_Shadow_array_p_gpc", (DL_FUNC) &_Shadow_array_p_gpc, 3},
    {"_Shadow_array_p_m_gpc", (DL_FUNC) &_Shadow_array_p_m_gpc, 3},
    {"_Shadow_p_gr", (DL_FUNC) &_Shadow_p_gr, 3},
    {"_Shadow_p_m_gr", (DL_FUNC) &_Shadow_p_m_gr, 3},
    {"_Shadow_array_p_gr", (DL_FUNC) &_Shadow_array_p_gr, 3},
    {"_Shadow_array_p_m_gr", (DL_FUNC) &_Shadow_array_p_m_gr, 3},
